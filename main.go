...
import (
	...
	"log"
	"net/http"
	"github.com/loicemeyo/go-graphql-api/gql"
	"github.com/loicemeyo/go-graphql-api/postgres"
	"github.com/loicemeyo/go-graphql-api/server"
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "loice", "go_graphql_db"),
	)
	if err != nil {
		log.Fatal(err)
	}
